...
var hcertJJ = "HC1:NCFOXN%TSMAHN-H$ZS*US4Z8%4Q16UM52ZAD1WG1NP RICG5:EA%188WA-98H*7F/8X*G3M9JUPY0BZW4P-AY GNNVR*G0C7PHBO336KN:IB3H3CWNZWV T8$S8 2363HOJJ473X G909/G77J5V.499TZ%HKK9+OC+G9QJPNF67J6QW6R3RZ466PPM4M5*1M6945104A+V96GAM PV$5NK9IN9HW04H9EN9ZM9 $U7T2 UQU$R.YU H2XJA/IE%TE6UG+ZE V1+GOT*OBR7Z6NC8P$WA3AA9EPBDSM+QQT6O67NC67Q4UYQD*O%+Q.SQBDOBKL/645YPL$R-RO%47+V4YC5/HQQ$PHCRH99FDOEA7IB65C94JB$*8OKDLC9JJCFJC6LFIJM6JC:D99MGEJC$0LVUCJ7R8X4G6HNS431T$VC+BNB4HUH75A78AL4%I9YVB0HNCF:8F$ 0VQR$ 0ID7MSV:NNV7J$%25I3HC3X83147/6HI2QX9Q938WHR4R78OE%%BHZNQBQF6OP8FT3D.AHB76I%1ROT3WRSGFORRMAPYE9L5I-/RW05DEHGEWGMUG07TQ0UORDQR00T 20T%EY2"
...
window.onload = async function () {
    ...
    keys = await $.get("assets/all_jwk_keys.json")
    console.log(keys)

    console.log("Hola!")

    dd = CWT.decodeHC1QR(hcertJJ)
    header = dd[0]
    console.log(header)
